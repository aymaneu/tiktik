    ...
    <div className="flex w-full h-full absolute left-0 top-[60px] mb-10 pt-10 lg:pt-20 bg-[#F8F8F8] justify-center">
      <div className="bg-white w-[60%] rounded-lg xl:h-[80vh] flex gap-6 flex-wrap justify-between items-center p-14 pt-6">
                ...
                {videoAsset ? (
                  ...
                  <label className="cursor-pointer">
                    <div className="flex flex-col items-center justify-center h-full">
                      ...
                      <p className="text-center text-gray-400 mt-10 text-sm leading-7">
        ...
        <div className="flex flex-col gap-3 pb-10">
          ...
          <select
            className="outline-none border-2 border-gray-200 rounded text-base capitalize lg:p-4 p-2 cursor-pointer"
